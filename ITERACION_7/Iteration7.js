...
console.log(exams.reduce((acc,cur)=>acc+cur.score,0))
...
console.log(exams.filter(exam=>exam.score>=5).reduce((sum,exam)=>sum+exam.score,0))

//! 7.3 Dado el mismo array, haz la media de las notas de todos los examenes .reduce().

console.log(exams.reduce((sum,exam)=>sum+exam.score,0)/exams.length)